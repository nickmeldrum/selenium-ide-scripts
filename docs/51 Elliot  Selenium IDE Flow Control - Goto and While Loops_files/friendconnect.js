...
var friendconnect_serverVersion = "0.1-207b465d_6726c20a_3336d841_8f275abc_b30c6b33.7";
...
b[c]},fcLa=Date.now||function(){return+new Date},fcT=function(a,b,c){fcDa(a,b,c)},fcU=function(a,b){function c(){}c.prototype=b[fc];a.Rc=b[fc];a.prototype=new c;a[fc].constructor=a;a.base=function(a,c,f){var k=fcf[fc][fcE][fcM](arguments,2);return b[fc][c][fcA](a,k)}};Function[fc].bind=Function[fc][fcja]||function(a,b){if(1<arguments[fcI]){var c=fcf[fc][fcE][fcM](arguments,1);c.unshift(this,a);return fcS[fcA](null,c)}return fcS(this,a)};var fcMa=function(a){if(fch.captureStackTrace)fch.captureStackTrace(this,fcMa);else{var b=fch().stack;b&&(this.stack=b)}a&&(this.message=fci(a))};fcU(fcMa,fch);fcMa[fc].name="CustomError";var fcNa=function(a,b){for(var c=a[fcu]("%s"),d="",e=fcf[fc][fcE][fcM](arguments,1);e[fcI]&&1<c[fcI];)d+=c[fcfa]()+e[fcfa]();return d+c[fcO]("%s")},fcOa=function(a,b){var c=fci(a)[fcBa](),d=fci(b)[fcBa]();return c<d?-1:c==d?0:1},fcWa=function(a,b){if(b)a=a[fco](fcPa,"&amp;")[fco](fcQa,"&lt;")[fco](fcRa,"&gt;")[fco](fcSa,"&quot;")[fco](fcTa,"&#39;")[fco](fcUa,"&#0;");else{if(!fcVa[fcsa](a))return a;-1!=a[fcG]("&")&&(a=a[fco](fcPa,"&amp;"));-1!=a[fcG]("<")&&(a=a[fco](fcQa,"&lt;"));-1!=a[fcG](">")&&
(a=a[fco](fcRa,"&gt;"));-1!=a[fcG]('"')&&(a=a[fco](fcSa,"&quot;"));-1!=a[fcG]("'")&&(a=a[fco](fcTa,"&#39;"));-1!=a[fcG]("\x00")&&(a=a[fco](fcUa,"&#0;"))}return a},fcPa=/&/g,fcQa=/</g,fcRa=/>/g,fcSa=/"/g,fcTa=/'/g,fcUa=/\x00/g,fcVa=/[\x00&<>"']/,fcYa=function(a,b){for(var c=0,d=fci(a)[fco](/^[\s\xa0]+|[\s\xa0]+$/g,"")[fcu]("."),e=fci(b)[fco](/^[\s\xa0]+|[\s\xa0]+$/g,"")[fcu]("."),f=fcg.max(d[fcI],e[fcI]),k=0;0==c&&k<f;k++){var l=d[k]||"",m=e[k]||"",n=RegExp("(\\d*)(\\D*)","g"),g=RegExp("(\\d*)(\\D*)",
"g");do{var h=n.exec(l)||["","",""],p=g.exec(m)||["","",""];if(0==h[0][fcI]&&0==p[0][fcI])break;var c=0==h[1][fcI]?0:fcca(h[1],10),s=0==p[1][fcI]?0:fcca(p[1],10),c=fcXa(c,s)||fcXa(0==h[2][fcI],0==p[2][fcI])||fcXa(h[2],p[2])}while(0==c)}return c},fcXa=function(a,b){return a<b?-1:a>b?1:0},fcZa=function(a){return fci(a)[fco](/\-([a-z])/g,function(a,c){return c.toUpperCase()})},fc_a=function(a,b){var c=fcQ(b)?fci(b)[fco](/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1")[fco](/\x08/g,"\\x08"):"\\s",c=c?"|["+c+"]+":
"",c=new RegExp("(^"+c+")([a-z])","g");return a[fco](c,function(a,b,c){return b+c.toUpperCase()})};var fc0a=function(a,b){b.unshift(a);fcMa[fcM](this,fcNa[fcA](null,b));b[fcfa]();this.messagePattern=a};fcU(fc0a,fcMa);fc0a[fc].name="AssertionError";var fc1a=function(a){throw a;},fc2a=fc1a,fc3a=function(a,b,c,d){var e="Assertion failed";if(c)var e=e+(": "+c),f=d;else a&&(e+=": "+a,f=b);a=new fc0a(""+e,f||[]);fc2a(a)},fc4a=function(a,b,c){a||fc3a("",null,b,fcf[fc][fcE][fcM](arguments,2));return a};var fc5a=fcf[fc],fc6a=fc5a[fcG]?function(a,b,c){fc4a(null!=a[fcI]);return fc5a[fcG][fcM](a,b,c)}:function(a,b,c){c=null==c?0:0>c?fcg.max(0,a[fcI]+c):c;if(fcQ(a))return fcQ(b)&&1==b[fcI]?a[fcG](b,c):-1;for(;c<a[fcI];c++)if(c in a&&a[c]===b)return c;return-1},fc7a=fc5a.forEach?function(a,b,c){fc4a(null!=a[fcI]);fc5a.forEach[fcM](a,b,c)}:function(a,b,c){for(var d=a[fcI],e=fcQ(a)?a[fcu](""):a,f=0;f<d;f++)f in e&&b[fcM](c,e[f],f,a)},fc8a=function(a,b){return 0<=fc6a(a,b)},fc9a=function(a){var b=a[fcI];
if(0<b){for(var c=fcf(b),d=0;d<b;d++)c[d]=a[d];return c}return[]},fc$a=function(a,b,c){fc4a(null!=a[fcI]);return 2>=arguments[fcI]?fc5a[fcE][fcM](a,b):fc5a[fcE][fcM](a,b,c)};var fcab=function(){var a=fcP.navigator;return a&&(a=a.userAgent)?a:""},fcbb=fcab(),fcV=function(a){var b=fcbb;return-1!=b[fcG](a)},fccb=function(a){var b=fcbb;return-1!=b[fcBa]()[fcG](a[fcBa]())};var fcdb=function(){return fcV("Opera")||fcV("OPR")},fceb=function(){return fcV("Trident")||fcV("MSIE")},fcfb=fcdb,fcgb=fceb;var fchb=fcfb(),fcW=fcgb(),fcib=fcV("Gecko")&&!fccb("WebKit")&&!(fcV("Trident")||fcV("MSIE")),fcjb=fccb("WebKit"),fclb=function(){var a="",b;if(fchb&&fcP.opera)return a=fcP.opera.version,"function"==fcEa(a)?a():a;fcib?b=/rv\:([^\);]+)(\)|;)/:fcW?b=/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/:fcjb&&(b=/WebKit\/(\S+)/);b&&(a=(a=b.exec(fcbb))?a[1]:"");return fcW&&(b=fckb(),b>parseFloat(a))?fci(b):a},fckb=function(){var a=fcP[fcJ];return a?a.documentMode:void 0},fcmb=fclb(),fcnb={},fcob=function(a){return fcnb[a]||
(fcnb[a]=0<=fcYa(fcmb,a))},fcpb=function(){var a=fcP[fcJ];if(a&&fcW){var b=fckb();return b||("CSS1Compat"==a.compatMode?fcca(fcmb,10):5)}}();var fcqb=function(a){for(var b=[],c=0,d=0;d<a[fcI];d++){for(var e=a[fcya](d);255<e;)b[c++]=e&255,e>>=8;b[c++]=e}return b};var fcrb=null,fcsb=null,fctb=null,fcub=null,fcwb=function(a,b){if(!fcFa(a))throw fch("encodeByteArray takes an array as a parameter");fcvb();for(var c=b?fctb:fcrb,d=[],e=0;e<a[fcI];e+=3){var f=a[e],k=e+1<a[fcI],l=k?a[e+1]:0,m=e+2<a[fcI],n=m?a[e+2]:0,g=f>>2,f=(f&3)<<4|l>>4,l=(l&15)<<2|n>>6,n=n&63;m||(n=64,k||(l=64));d[fcC](c[g],c[f],c[l],c[n])}return d[fcO]("")},fcxb=function(a,b){fcvb();for(var c=b?fcub:fcsb,d=[],e=0;e<a[fcI];){var f=c[a[fcp](e++)],k=e<a[fcI],k=k?c[a[fcp](e)]:0;++e;var l=e<a[fcI],
l=l?c[a[fcp](e)]:64;++e;var m=e<a[fcI],m=m?c[a[fcp](e)]:64;++e;if(null==f||null==k||null==l||null==m)throw fch();f=f<<2|k>>4;d[fcC](f);64!=l&&(f=k<<4&240|l>>2,d[fcC](f),64!=m&&(f=l<<6&192|m,d[fcC](f)))}return d},fcvb=function(){if(!fcrb){fcrb={};fcsb={};fctb={};fcub={};for(var a=0;65>a;a++)fcrb[a]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="[fcp](a),fcsb[fcrb[a]]=a,fctb[a]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_."[fcp](a),fcub[fctb[a]]=a}};var fcyb=function(){this.blockSize=-1};var fcX=function(a,b,c){fcyb[fcM](this);this.i=a;this.blockSize=c||a.blockSize||16;this.Xb=fcf(this.blockSize);this.Va=fcf(this.blockSize);this.Tb(b)};fcU(fcX,fcyb);fcX[fc].Tb=function(a){a[fcI]>this.blockSize&&(this.i[fcN](a),a=this.i.digest(),this.i[fcpa]());for(var b,c=0;c<this.blockSize;c++)b=c<a[fcI]?a[c]:0,this.Xb[c]=b^92,this.Va[c]=b^54;this.i[fcN](this.Va)};fcX[fc].reset=function(){this.i[fcpa]();this.i[fcN](this.Va)};fcX[fc].update=function(a,b){this.i[fcN](a,b)};
fcX[fc].digest=function(){var a=this.i.digest();this.i[fcpa]();this.i[fcN](this.Xb);this.i[fcN](a);return this.i.digest()};fcX[fc].Jb=function(a){this[fcpa]();this[fcN](a);return this.digest()};var fcY=function(){fcyb[fcM](this);this.blockSize=64;this.c=[];this.Ca=[];this.Ic=[];this.sa=[];this.sa[0]=128;for(var a=1;a<this.blockSize;++a)this.sa[a]=0;this.ya=this.G=0;this[fcpa]()};fcU(fcY,fcyb);fcY[fc].reset=function(){this.c[0]=1732584193;this.c[1]=4023233417;this.c[2]=2562383102;this.c[3]=271733878;this.c[4]=3285377520;this.ya=this.G=0};
...
fcZ[fc].remove=function(a,b,c){var d=this.M(a);this.set(a,"",0,b,c);return d};fcZ[fc].r=function(){return this.ha().keys};fcZ[fc].F=function(){return this.ha().values};fcZ[fc].P=function(){var a=this.Na();return a?this.ja()[fcI]:0};fcZ[fc].M=function(a){return fcCa(this.get(a))};fcZ[fc].clear=function(){for(var a=this.ha().keys,b=a[fcI]-1;0<=b;b--)this.remove(a[b])};fcZ[fc].wc=function(a){this.xb.cookie=a};fcZ[fc].Na=function(){return this.xb.cookie};fcZ[fc].ja=function(){return(this.Na()||"")[fcu](fczb)};
fcZ[fc].ha=function(){for(var a=this.ja(),b=[],c=[],d,e,f=0;e=a[f];f++)d=e[fcG]("="),-1==d?(b[fcC](""),c[fcC](e)):(b[fcC](e[fcza](0,d)),c[fcC](e[fcza](d+1)));return{keys:b,values:c}};var fcAb=new fcZ(fce);fcAb.MAX_COOKIE_LENGTH=3950;var fcBb=function(a,b){fcea(a,b)},fcCb=function(a){a=a.className;return fcQ(a)&&a[fcq](/\S+/g)||[]},fcEb=function(a,b){var c=fcCb(a),d=fc$a(arguments,1),e=c[fcI]+d[fcI];fcDb(c,d);fcBb(a,c[fcO](" "));return c[fcI]==e},fcDb=function(a,b){for(var c=0;c<b[fcI];c++)fc8a(a,b[c])||a[fcC](b[c])};var fc_=function(a,b){fcj(this,a);fck(this,b)};fc_[fc].clone=function(){return new fc_(this[fcn],this[fcB])};fc_[fc].toString=function(){return"("+this[fcn]+" x "+this[fcB]+")"};fc_[fc].ceil=function(){fcj(this,fcg.ceil(this[fcn]));fck(this,fcg.ceil(this[fcB]));return this};fc_[fc].floor=function(){fcj(this,fcg.floor(this[fcn]));fck(this,fcg.floor(this[fcB]));return this};fc_[fc].round=function(){fcj(this,fcg[fcD](this[fcn]));fck(this,fcg[fcD](this[fcB]));return this};
fc_[fc].scale=function(a,b){var c="number"==typeof b?b:a;fcj(this,this[fcn]*a);fck(this,this[fcB]*c);return this};var fcFb=function(a,b,c){for(var d in a)b[fcM](c,a[d],d,a)},fcGb=function(a){var b=[],c=0,d;for(d in a)b[c++]=a[d];return b},fcHb=function(a){var b=[],c=0,d;for(d in a)b[c++]=d;return b},fcIb="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" "),fcJb=function(a,b){for(var c,d,e=1;e<arguments[fcI];e++){d=arguments[e];for(c in d)a[c]=d[c];for(var f=0;f<fcIb[fcI];f++)c=fcIb[f],fcaa[fc].hasOwnProperty[fcM](d,c)&&(a[c]=d[c])}};var fcKb=!fcW||fcW&&9<=fcpb;!fcib&&!fcW||fcW&&fcW&&9<=fcpb||fcib&&fcob("1.9.1");fcW&&fcob("9");var fcLb=function(a){return fcQ(a)?fce[fcF](a):a},fcMb=fcLb,fcNb=function(a,b,c,d){a=d||a;b=b&&"*"!=b?b.toUpperCase():"";if(a.querySelectorAll&&a.querySelector&&(b||c))return c=b+(c?"."+c:""),a.querySelectorAll(c);if(c&&a.getElementsByClassName){a=a.getElementsByClassName(c);if(b){d={};for(var e=0,f=0,k;k=a[f];f++)b==k.nodeName&&(d[e++]=k);fcda(d,e);return d}return a}a=a.getElementsByTagName(b||"*");if(c){d={};for(f=e=0;k=a[f];f++)b=k.className,"function"==typeof b[fcu]&&fc8a(b[fcu](/\s+/),c)&&(d[e++]=
k);fcda(d,e);return d}return a},fcPb=function(a,b){fcFb(b,function(b,d){"style"==d?a[fcw].cssText=b:"class"==d?fcea(a,b):"for"==d?a.htmlFor=b:d in fcOb?a[fcs](fcOb[d],b):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a[fcs](d,b):a[d]=b})},fcOb={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",frameborder:"frameBorder",height:"height",maxlength:"maxLength",role:"role",rowspan:"rowSpan",type:"type",usemap:"useMap",valign:"vAlign",width:"width"},fcQb=function(a){a=a[fcJ];
a="CSS1Compat"==a.compatMode?a.documentElement:a[fcL];return new fc_(a.clientWidth,a.clientHeight)},fc0=function(a,b,c){return fcRb(fce,arguments)},fcRb=function(a,b){var c=b[0],d=b[1];if(!fcKb&&d&&(d[fcH]||d[fcwa])){c=["<",c];d[fcH]&&c[fcC](' name="',fcWa(d[fcH]),'"');if(d[fcwa]){c[fcC](' type="',fcWa(d[fcwa]),'"');var e={};fcJb(e,d);delete e[fcwa];d=e}c[fcC](">");c=c[fcO]("")}c=a[fcr](c);d&&(fcQ(d)?fcea(c,d):"array"==fcEa(d)?fcea(c,d[fcO](" ")):fcPb(c,d));2<b[fcI]&&fcSb(a,c,b,2);return c},fcSb=
function(a,b,c,d){function e(c){c&&b[fcm](fcQ(c)?a.createTextNode(c):c)}for(;d<c[fcI];d++){var f=c[d];!fcFa(f)||fcGa(f)&&0<f.nodeType?e(f):fc7a(fcTb(f)?fc9a(f):f,e)}},fcUb=function(a){fc4a(a,"Node cannot be null or undefined.");return 9==a.nodeType?a:a.ownerDocument||a[fcJ]},fcTb=function(a){if(a&&"number"==typeof a[fcI]){if(fcGa(a))return"function"==typeof a.item||"string"==typeof a.item;if("function"==fcEa(a))return"function"==typeof a.item}return!1};var fcVb="StopIteration"in fcP?fcP.StopIteration:fch("StopIteration"),fcWb=function(){};fcWb[fc].next=function(){throw fcVb;};fcWb[fc].__iterator__=function(){return this};var fc1=function(a,b){this.j={};this.e=[];this.$=this.v=0;var c=arguments[fcI];if(1<c){if(c%2)throw fch("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else a&&this.ob(a)};fc1[fc].P=function(){return this.v};fc1[fc].F=function(){this.K();for(var a=[],b=0;b<this.e[fcI];b++){var c=this.e[b];a[fcC](this.j[c])}return a};fc1[fc].r=function(){this.K();return this.e.concat()};fc1[fc].M=function(a){return fcXb(this.j,a)};
fc1[fc].clear=function(){this.j={};fcda(this.e,0);this.$=this.v=0};fc1[fc].remove=function(a){return fcXb(this.j,a)?(delete this.j[a],this.v--,this.$++,this.e[fcI]>2*this.v&&this.K(),!0):!1};fc1[fc].K=function(){if(this.v!=this.e[fcI]){for(var a=0,b=0;a<this.e[fcI];){var c=this.e[a];fcXb(this.j,c)&&(this.e[b++]=c);a++}fcda(this.e,b)}if(this.v!=this.e[fcI]){for(var d={},b=a=0;a<this.e[fcI];)c=this.e[a],fcXb(d,c)||(this.e[b++]=c,d[c]=1),a++;fcda(this.e,b)}};
fc1[fc].get=function(a,b){return fcXb(this.j,a)?this.j[a]:b};fc1[fc].set=function(a,b){fcXb(this.j,a)||(this.v++,this.e[fcC](a),this.$++);this.j[a]=b};fc1[fc].ob=function(a){var b;a instanceof fc1?(b=a.r(),a=a.F()):(b=fcHb(a),a=fcGb(a));for(var c=0;c<b[fcI];c++)this.set(b[c],a[c])};fc1[fc].forEach=function(a,b){for(var c=this.r(),d=0;d<c[fcI];d++){var e=c[d],f=this.get(e);a[fcM](b,f,e,this)}};fc1[fc].clone=function(){return new fc1(this)};
fc1[fc].__iterator__=function(a){this.K();var b=0,c=this.e,d=this.j,e=this.$,f=this,k=new fcWb;k.next=function(){for(;;){if(e!=f.$)throw fch("The map has changed since the iterator was created");if(b>=c[fcI])throw fcVb;var k=c[b++];return a?k:d[k]}};return k};var fcXb=function(a,b){return fcaa[fc].hasOwnProperty[fcM](a,b)};var fcZb=function(a,b,c){fcQ(b)?fcYb(a,c,b):fcFb(b,fcJa(fcYb,a))},fcYb=function(a,b,c){(c=fc_b(a,c))&&(a[fcw][c]=b)},fc_b=function(a,b){var c=fcZa(b);if(void 0===a[fcw][c]){var d=(fcjb?"Webkit":fcib?"Moz":fcW?"ms":fchb?"O":null)+fc_a(c);if(void 0!==a[fcw][d])return d}return c},fc0b=function(a,b){var c=fcUb(a);return c.defaultView&&c.defaultView.getComputedStyle&&(c=c.defaultView.getComputedStyle(a,null))?c[b]||c.getPropertyValue(b)||"":""},fc1b=function(a,b){return fc0b(a,b)||(a.currentStyle?a.currentStyle[b]:
null)||a[fcw]&&a[fcw][b]},fc2b=function(a){var b;try{b=a.getBoundingClientRect()}catch(c){return{left:0,top:0,right:0,bottom:0}}fcW&&a.ownerDocument[fcL]&&(a=a.ownerDocument,b.left=b[fcta]-(a.documentElement.clientLeft+a[fcL].clientLeft),b.top-=a.documentElement.clientTop+a[fcL].clientTop);return b},fc5b=function(a,b,c){if(b instanceof fc_)c=b[fcB],b=b[fcn];else if(void 0==c)throw fch("missing height argument");fc3b(a,b);fc4b(a,c)},fc6b=function(a,b){"number"==typeof a&&(a=(b?fcg[fcD](a):a)+"px");
return a},fc4b=function(a,b){fck(a[fcw],fc6b(b,!0))},fc3b=function(a,b){fcj(a[fcw],fc6b(b,!0))},fc7b=function(a,b){if("none"!=fc1b(b,"display"))return a(b);var c=b[fcw],d=c.display,e=c.visibility,f=c.position;c.visibility="hidden";c.position="absolute";c.display="inline";var k=a(b);c.display=d;c.position=f;c.visibility=e;return k},fc8b=function(a){var b=a.offsetWidth,c=a.offsetHeight,d=fcjb&&!b&&!c;return fcCa(b)&&!d||!a.getBoundingClientRect?new fc_(b,c):(a=fc2b(a),new fc_(a[fcqa]-a[fcta],a.bottom-
a.top))},fc9b=function(a,b){a[fcw].display=b?"":"none"};var fc$b={},fcac={};var fcbc=function(a,b,c,d){b=b||"800";c=c||"550";d=d||"friendconnect";a=fcc.open(a,d,"menubar=no,toolbar=no,dialog=yes,location=yes,alwaysRaised=yes,width="+b+",height="+c+",resizable=yes,scrollbars=1,status=1");fcc.focus&&a&&a.focus()},fccc=function(a,b){var c=fca[fcz][fcK]().communityId;fca.rpc[fcM](null,"signin",null,c,a,b)};fcT("goog.peoplesense.util.openPopup",fcbc);fcT("goog.peoplesense.util.finishSignIn",fccc);var fcfc=function(a,b){var c=fcdc()+"/friendconnect/invite/friends",d=fcb(shindig[fcha][fcia]());fcec(c,d,a,b)},fcec=function(a,b,c,d){a+="?st="+b;c&&(a+="&customMessage="+fcb(c));d&&(a+="&customInviteUrl="+fcb(d));b=760;fcW&&(b+=25);fcbc(a,fci(b),"515","friendconnect_invite")};fcT("goog.peoplesense.util.invite",fcfc);fcT("goog.peoplesense.util.inviteFriends",fcec);var fcgc=function(a){this.url=a};fcgc[fc].l=function(a,b){if(0<=this.url[fcG]("?"+a+"=")||0<=this.url[fcG]("&"+a+"="))throw fch("duplicate: "+a);if(null===b||void 0===b)return this;var c=0<=this.url[fcG]("?")?"&":"?";this.url+=c+a+"="+fcb(fci(b));return this};fcgc[fc].toString=function(){return this.url};var fcdc=function(){return fcc[fcxa]},fchc=function(a,b,c,d,e,f,k){b=b||"800";c=c||"550";d=d||"friendconnect";f=f||!1;fca.rpc[fcM](null,"openLightboxIframe",k,a,shindig[fcha][fcia](),b,c,d,e,null,null,null,f)},fcic=function(a,b){var c=fca[fcz][fcK]().psinvite||"",d=new fcgc(fcdc()+"/friendconnect/signin/home");d.l("st",fcc.shindig[fcha][fcia]());d.l("psinvite",c);d.l("iframeId",a);d.l("loginProvider",b);d.l("subscribeOnSignin","1");fcbc(d[fcka]());return!1},fcjc=function(){var a=fca[fcz][fcK]().communityId;
fca.rpc[fcM](null,"signout",null,a)},fclc=function(a,b){var c=fcdc()+"/friendconnect/settings/edit?st="+fcb(shindig[fcha][fcia]())+(a?"&iframeId="+fcb(a):"");b&&(c=c+"&"+b);fckc(c)},fcmc=function(a){a=fcdc()+"/friendconnect/settings/siteProfile?st="+fcb(a);fckc(a)},fckc=function(a){var b=800;fcW&&(b+=25);fcbc(a,fci(b),"510")},fcnc=function(a,b,c,d){d=d||2;var e=null;if("text"==b)e=fc0("div",{"class":"gfc-button-text"},fc0("div",{"class":"gfc-icon"},fc0("a",{href:"javascript:void(0);"},c))),a[fcm](e);
...
cellspacing:"0"},fc0("tbody",{"class":""},fc0("tr",{"class":""},fc0("td",{"class":"gfc-button-base-v2 gfc-button-1"}),fc0("td",{"class":"gfc-button-base-v2 gfc-button-2"},c),fc0("td",{"class":"gfc-button-base-v2 gfc-button-3"})))),a[fcm](e),"standard"==b&&(b=fc0("div",{"class":"gfc-footer-msg"},"with Google Friend Connect"),1==d&&a[fcm](fc0("br")),a[fcm](b));return e},fcoc=function(a,b){if(!a)throw"google.friendconnect.renderSignInButton: missing options";var c=a[fcw]||"standard",d=a.text,e=a.version;
if("standard"==c)d=a.text||"Sign in";else if("text"==c||"long"==c)d=a.text||"Sign in with Friend Connect";var f=a.element;if(!f){f=a.id;if(!f)throw"google.friendconnect.renderSignInButton: options[id] and options[element] == null";f=fcMb(f);if(!f)throw"google.friendconnect.renderSignInButton: element "+a.id+" not found";}fcl(f,"");c=fcnc(f,c,d,e);fcc[fcua]?c[fcua]("click",b,!1):c.attachEvent("onclick",b)},fcpc=function(a,b){b=b||fcS(fcic,null,null,null,null);fcoc(a,b)},fcqc=function(a,b){fca.rpc[fcM](null,
"putReloadViewParam",null,a,b);var c=fca.views.getParams();c[a]=b},fcrc=function(a,b){var c=new fcgc("/friendconnect/gadgetshare/friends");c.l("customMessage",a);c.l("customInviteUrl",b);c.l("container","glb");var d=310;fcW&&(d+=25);fchc(c[fcka](),fci(d),"370")};fcT("goog.peoplesense.util.getBaseUrl",fcdc);fcT("goog.peoplesense.util.finishSignIn",fccc);fcT("goog.peoplesense.util.signout",fcjc);fcT("goog.peoplesense.util.signin",fcic);fcT("goog.peoplesense.util.editSettings",fclc);
fcT("goog.peoplesense.util.editSSProfile",fcmc);fcT("goog.peoplesense.util.setStickyViewParamToken",fcqc);fcT("google.friendconnect.renderSignInButton",fcpc);fcT("goog.peoplesense.util.share",fcrc);fcT("goog.peoplesense.util.userAgent.IE",fcW);var fcsc={},fc2=function(a){this.h=new fc1;this.snippetId=a.id;this.site=a.site;a=a["view-params"];var b=a.skin;this.hc=(b?b.POSITION:"top")||"top";this.Jc={allowAnonymousPost:a.allowAnonymousPost||!1,scope:a.scope||"SITE",docId:a.docId||"",features:a.features||"video,comment",startMaximized:"true",disableMinMax:"true",skin:b};this.absoluteBottom=fcW&&!fcob("7");this.fixedIeSizes=fcW;fcc[fcua]?fcc[fcua]("resize",fcS(this.eb,this),!1):fcc.attachEvent("onresize",fcS(this.eb,this));this.tb()};
fc2[fc].tb=function(){if(!this.site)throw fch("Must supply site ID.");if(!this.snippetId)throw fch("Must supply a snippet ID.");};fc2[fc].b=10;fc2[fc].Ba=1;fc2[fc].q="fc-friendbar-";fc2[fc].t=fc2[fc].q+"outer";fc2[fc].hb=fc2[fc].t+"-shadow";fc2[fc].render=function(){fce.write(this.Bb());var a=fcLb(this.snippetId);fcl(a,this.O())};fc2[fc].Cb=function(){var a=fcLb(this.t);return a=fc7b(fc8b,a)[fcn]};fc2[fc].eb=function(){for(var a=this.h.r(),b=0;b<a[fcI];b++)this.tc(a[b]);goog&&fc$b&&fcac&&fctc&&fcuc("resize")};
...
fc2[fc].Fc=function(a,b){var c=this.h.get(a);if(c){c.drawer||(c.drawer=fcLb(this.fa(c[fcH])),c.target=fcLb(this.R(c[fcH])),c.sha_bc=fcNb(fce,"div","top"==this.n()?this.d("bc"):this.d("tc"),c.drawer)[0],c.sha_cr=fcNb(fce,"div",this.d("cr"),c.drawer)[0]);for(var d=this.h.r(),e=0;e<d[fcI];e++){var f=d[e];a!==f&&this.ma(f)}c.da(b);fc9b(c.drawer,!0);fcc.setTimeout(function(){c.Aa();c.Ka();c.render()},0)}};
...
fc3[fc].da=function(a){fcJb(this.constraints,a||{});fcJb(this.skin,this.constraints);if(this.bar.fixedIeSizes&&this.constraints[fcta]&&this.constraints[fcqa]){a=this.bar.Cb();var b=this.constraints[fcta],c=this.constraints[fcqa];a-=b+c;a%2&&(a-=1,this.skin.right=this.skin[fcqa]+1);fcj(this.skin,a);delete this.skin[fcta]}};
fc3[fc].Aa=function(){if(this.drawer){if(this.skin[fcn]){var a=this.bar.Ba,b=this.bar.b,c=fcW?2:0;fc5b(this.target,this.skin[fcn],"");fc5b(this.sha_bc,this.skin[fcn]-b+2*a-c,"");this.skin.rightShadow?fc5b(this.drawer,this.skin[fcn]+b+2*a-c,""):fc5b(this.drawer,this.skin[fcn]+2*a-c,"")}this.skin[fcqa]&&(this.drawer[fcw].right=this.skin[fcqa]+0+"px")}};
fc3[fc].Ka=function(){if(fcW&&this.drawer){var a=fc7b(fc8b,this.target),b=a[fcn]-this.bar.b,a=a[fcB];0>b&&(b=0);this.sha_bc&&this.sha_bc[fcw]&&fc5b(this.sha_bc,b,"");this.sha_cr&&this.sha_cr[fcw]&&fc5b(this.sha_cr,"",a)}};
fc3[fc].O=function(){var a="display:none;",b="position: relative; ",c="",d="",e="",f="",k=!!this.skin.rightShadow;k||(c+="display: none; ",e+="display: none; ",d+="right: 0px; ",f+="margin-right: 0px; ");for(var l in this.skin){var m=Number(this.skin[l]);k&&0==fcOa(l,"width")&&(m+=this.bar.b);0==fcOa(l,"height")&&(b+=l+": "+m+"px; ");"rightShadow"!=l&&(0==fcOa(l,"height")&&(m+=this.bar.b),0==fcOa(l,"width")&&(m+=2),a+=l+": "+m+"px; ");fcW&&0==fcOa(l,"width")&&(m=k?m-2*this.bar.b:m-this.bar.b,d+=l+
...
fc3[fc].render=function(){if(!1==this.rendered){var a={};a.url=this.url;a.id=this.bar.R(this[fcH]);a.site=this.bar.site;a["view-params"]=fcR(this.bar.Jc);"profile"==this[fcH]&&(a["view-params"].profileId="VIEWER");this.skin&&fcJb(a["view-params"].skin,this.skin);a["view-params"].menuName=this[fcH];a["view-params"].opaque="true";a["view-params"].menuPosition=this.bar.hc;fck(a,"1px");fcc.google&&fcsc&&fc4&&(this.id=fc4.render(a))}};fcT("google.friendconnect.FriendBar",fc2);var fcwc=function(a){a=new fcvc(a);if(a.qa()%5)throw fch();for(var b=[],c=0;0<a.qa();c++)b[c]="0123456789abcdefghijklmnopqrstuv"[fcp](a.fc(5));return b[fcO]("")},fcvc=function(a){this.H=this.o=0;this.ca=a};fcvc[fc].qa=function(){return 8*(this.ca[fcI]-this.H)-this.o};
fcvc[fc].fc=function(a){var b=0;if(a>this.qa())throw fch();if(0<this.o){var b=255>>this.o&this.ca[this.H],c=8-this.o,d=fcg.min(a%8,c),c=c-d,b=b>>c;a-=d;this.o+=d;8==this.o&&(this.o=0,this.H++)}for(;8<=a;)b<<=8,b|=this.ca[this.H],this.H++,a-=8;0<a&&(b<<=a,b|=this.ca[this.H]>>8-a,this.o=a);return b};var fcxc=(new Date).getTime(),fc5=function(){},fcyc=function(){},fczc=function(){},fcAc=function(){};fcU(fcAc,fczc);var fcBc=function(a){if(a)for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b]);if(this.viewParams)for(var c in this.viewParams)/^FC_RELOAD_.*$/[fcsa](c)&&(this.viewParams[c]=null)};fcBc[fc].render=function(a){var b=this;a&&(b.Hc(),this.Eb(function(c){fcZb(a,"visibility","hidden");fcl(a,c);b.refresh(a,c);c=function(a){fcZb(a,"visibility","visible")};c=fcJa(c,a);fcba(c,500);b.chrome=a}))};
...
fc9[fc].ub=function(a){var b=new fcY;a=fcqb(a);b[fcN](a);b=b.digest();return b=fcwc(b)};
...
fc9[fc].jb=function(a,b){a=a||{};var c=a[fcva],d=fcIc(c),e=this;this.u();this.Z(function(b){var c=fc0("div",{},fc0("div",{id:"gadget-signin",style:"background-color:#ffffff;height:32px;"}),fc0("div",{id:"gadget-lb-canvas",style:"background-color:#ffffff;"}));b.getTitleTextElement()[fcm](fc0("div",{id:"gfc-canvas-title",style:"color:#000000;"}));b[fcAa]()[fcm](c);b.setVisible(!0);var c=fcR(a),l=fcQb(fcc),m=fcg[fcD](.7*l[fcB]),l={BORDER_COLOR:"#cccccc",ENDCAP_BG_COLOR:"#e0ecff",ENDCAP_TEXT_COLOR:"#333333",
ENDCAP_LINK_COLOR:"#0000cc",ALTERNATE_BG_COLOR:"#ffffff",CONTENT_BG_COLOR:"#ffffff",CONTENT_LINK_COLOR:"#0000cc",CONTENT_TEXT_COLOR:"#333333",CONTENT_SECONDARY_LINK_COLOR:"#7777cc",CONTENT_SECONDARY_TEXT_COLOR:"#666666",CONTENT_HEADLINE_COLOR:"#333333"};c.id="gadget-lb-canvas";fck(c,fcg.min(498,m)+"px");c.maxHeight=m;c.keepMax&&(fck(c,m),fcZb(b[fcAa](),"height",m+35+"px"));c["view-params"]=c["view-params"]||{};c["view-params"].opaque=!0;c["view-params"].skin=c["view-params"].skin||{};fcKa(c["view-params"].skin,
...
fc5[fc].signout=function(a){fc4.$a(fc4.ea(a));fc4.$a(fc4.ka(a));fc4.Ga={};fc4.U();return!1};fc9[fc].$a=function(a){for(var b=fce[fcv].pathname,b=b[fcu]("/"),c=0;c<b[fcI];c++){for(var d=fcf(c+1),e=0;e<c+1;e++)d[e]=b[e];fcAb.remove(a,d[fcO]("/")+"/")}};
fc5[fc].fb=function(a){var b=fce[fcF](this.f);b&&0<a&&fck(b[fcw],a+"px");(b=fce[fcF](this.f+"_body"))&&0<a&&fck(b[fcw],a+"px");if(b=fc$(this.f)){var c=fc4.A(b);c&&((b=fce[fcF](c.divId))&&0<a&&(c&&c[fcoa]&&c[fcoa]<a&&(a=c[fcoa],b[fcw].overflowY="auto"),fck(b[fcw],a+"px")),!c.keepMax&&"canvas"==c.la()&&fc4.lastLightboxDialog&&fc4.lastLightboxDialog.reposition(),fcZb(c.chrome,"visibility","visible"))}};fc5[fc].setTitle=function(a){var b=fc$(this.f),b=fc4.A(b);(b=b.titleDivId)&&fcl(fce[fcF](b),fca[fcz].escapeString(a))};
fc5[fc].signin=function(a,b,c){fcAb.set(fc4.ea(a),b,31104E3,c);fcAb.set(fc4.ka(a),b,-1,c);fc4.Ga[a]=b;fc4.U()};var fcKc=function(a){fcpc(a,fcJc)};fc9[fc].oc=function(a,b){b&&this.m(b,a);var c={};c.url=fcd+"/friendconnect/gadgets/members.xml";this.render(this.s(a,c))};fc9[fc].qc=function(a,b){b&&this.m(b,a);var c={};c.url=fcd+"/friendconnect/gadgets/review.xml";c["view-params"]={startMaximized:"true",disableMinMax:"true",features:"review"};this.render(this.s(a,c))};
...
fc9[fc].Ec=function(a,b){this.Z(function(c){var d=fce.createTextNode("Copy & paste this code into your site.");c[fcAa]()[fcm](d);c[fcAa]()[fcm](fce[fcr]("br"));var d=fc4.C(a,b),e=fce[fcr]("textarea");fcl(e,d);e[fcs]("style","width:500px;");c[fcAa]()[fcm](e);c.setVisible(!0)})};var fcMc="ar dv fa iw he ku pa sd tk ug ur yi".split(" "),fcIc=function(a){var b=!1;a?(a=a[fcu]("_")[0],b=fc8a(fcMc,a)):b=(a=fc0b(fce[fcL],"direction"))&&"rtl"==a;return b};
...
fc9[fc].Hb=function(a){var b=null;(a=this.Q(a))&&a.communityId&&(b=a.communityId);return b};var fcJc=function(a){fc4.I&&fcic(fc4.I,a)},fcNc=function(){fc5[fc].signout(fc4.openSocialSiteId)},fcOc=function(){fclc(fc4.I)},fcPc=function(a,b){fcfc(a,b)},fctc=function(){this.p={}};fctc[fc].register=function(){fca.rpc[fct]("subscribeEventType",fc5[fc].subscribe);fca.rpc[fct]("publishEvent",fc5[fc].publish)};fc5[fc].subscribe=function(a){var b=fcGc;b.p[a]=b.p[a]||[];a=b.p[a];a[a[fcI]]={frameId:this}};
fctc[fc].lb=function(a,b,c){var d=this;d.p[b]=d.p[b]||[];b=d.p[b];b[b[fcI]]={container:a,callback:c}};fc5[fc].publish=function(a){var b=fcGc,c=0;this.f&&(c=fc$(this.f));b.p[a]=b.p[a]||[];for(var b=b.p[a],d=0;d<b[fcI];d++)b[d].container?b[d].callback[fcM](b[d].container,a,c):fca.rpc[fcM](b[d].frameId,a,null,a,c)};var fcuc=fcS(fc5[fc].publish,new fc5),fcGc=new fctc,fc4=new fc9;fc4.Da(fc4.zb);fcT("google.friendconnect.container",fc4);fcT("google.friendconnect.container.refreshGadgets",fc4.U);
...
google.friendconnect.container.setDateStamp_('1476760a2c0');